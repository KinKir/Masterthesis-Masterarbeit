 ...
 */
/**
 * project the tables from data.json with the name's array of tables.
 * @param tables the array of tables' names.
 * @returns {tupleset_basic_array} table sets with struct [{table1},{table2},...,{tablen}].
 *
 */
var projection = function(tables) {
  var tuplesOutput = [];
